...
(function($) {
  this.FilmRoll = (function() {
    ...
    FilmRoll.prototype.configure = function() {
      ...
      if (this.options.prev !== false) {
        if (this.options.prev && this.options.next) {
          ...
          this.wrapper.append('<div class="control-container"></div>');
          this.wrapper.find('.control-container').append('<a class="film_roll_prev" href="#"></a>')
      ...
      if (this.options.next !== false) {
        if (this.options.next) {
          ...
          this.wrapper.find('.control-container').append('<a class="film_roll_next" href="#"></a>');
    ...
    FilmRoll.prototype.moveToIndex = function(index, direction, animate) {
      ...
      this.children.prev().removeClass('opacity');
      $(child).addClass('active').trigger($.Event("film_roll:activate"));
      $(child).addClass('active').prev().addClass('opacity')
